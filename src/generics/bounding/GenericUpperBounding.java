...
public class GenericUpperBounding <T extends Number>{//setting boundry from Upper
    ...
    //let us create main method here
...
//        GenericUpperBounding<String> obj4 = new GenericUpperBounding<>(floatArr);
//        System.out.println(obj3.getAverage());  //it will save us from run time exceptions also typeCasting
